...
class CommentRouter {
    ...
    deleteRoutes() {
        this.router.delete('/delete/:id', GlobalMiddleWare_1.GlobalMiddleWare.authenticate, CommentValidators_1.CommentValidator.deleteComment(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, CommentController_1.CommentController.deleteComment);
    }
}
